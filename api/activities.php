...
if ($method === 'GET') {
    $statement = $pdo->query(
        'SELECT id, title, start_time, end_time, assignee, completed, location, description, activity_date
         FROM activities
...
if ($method === 'POST') {
    $statement = $pdo->prepare(
        ...
        (title, start_time, end_time, assignee, completed, location, description, activity_date)
        VALUES (:title, :start_time, :end_time, :assignee, :completed, :location, :description, :activity_date)'
    );
